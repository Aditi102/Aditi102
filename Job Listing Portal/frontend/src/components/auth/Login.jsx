            ...
            <div className='flex items-center justify-center flex-grow'>
                <form onSubmit={submitHandler} className='w-full max-w-md bg-white shadow-lg rounded-lg p-8'>
                    ...
                    <div className='text-center'>
                        <span className="text-gray-600">Do not have an account? <Link to="/Signup" className='text-indigo-600 hover:text-indigo-500 underline'>Sign Up</Link></span>
                    </div>
                </form>
            </div>
        </div>
